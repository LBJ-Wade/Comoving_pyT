...
class solver():
	...
	def __init__(self, Nspan, Nfield, interpolated, Rtol, Atol):
		...
		x = 1#np.sqrt(1/(2 * epsilon * self.Mp**2)) #Canonnically normalised field
	...
	def fffCalc(self, k1, k2, k3):
		...
		#Fake interaction
		#fff[1, 1, 1] += 1/(a*a*a*a)/4/(k1*k2*k3)/kt*(- 1/self.Mp**2 * kt**2)
	...
	def pffCalc(self, k1, k2, k3):
		...
		#Fake interaction
		#pff[1, 1, 1] += - 1./(a*a*a)/4./K3 * Hi * (-k1*k1*k2*k3/kt) * (- 1/self.Mp**2 * kt**2)
		#pff[1, 1, 1] += - 1./(a*a*a)/4./K3 * Hi * (-k1*k1*k2*k3/kt) * (1/self.Mp**2 * kt**4)
	...
	def ppfCalc(self, k1, k2, k3):
			...
			for j in range(Nfield):
				for k in range(Nfield):
					ppf[i, j, k] += -1./(a*a*a*a)/4./K3 * (k1*k2*k3)*(k1*k2*k3)/kt*k1*k2*(-C123[i, j, k]*k1*k2 - C132[i, k, j]*k1*k3 - C231[j, k, i]*k2*k3
																	...
																	#+ k1*k1*k2*k2*a*a*Hi*B123[i, j, k]*k1*k2*k3*k3 *k3*k3/k2/k2
																	#+ k1*k1*k2*k2*a*a*Hi*B132[i, k, j]*k1*k3*k2*k2 *k2*k2/k1/k1
																	#+ k1*k1*k2*k2*a*a*Hi*B231[j, k, i]*k2*k3*k1*k1 *k1*k1/k3/k3
		...
		#Fake interaction
		#ppf[1, 1, 1] += 1./(a*a*a*a)/4./K3 * (k1*k2*k3)*(k1*k2*k3)/kt*k1*k2*(- 1/self.Mp**2 * kt**2)
	...
	def pppCalc(self, k1, k2, k3):
		...
		#Fake interaction
		#ppp[1, 1, 1] += - 1./(a*a*a)/4./K3 * Hi * (k1*k1*k2*k2*k3*k3)/kt  * (1/self.Mp**2 * kt**4*(1.+kt/kt))
	...
	def B_init(self, k1, k2, k3):
		...
		print("$\zeta\zeta\zeta$")
		print(B[0, 0, 0])
		print("$\zeta\zeta\pi_{\zeta}$")
		print(B[0, 0, 2])
		print("$\zeta\pi_{\zeta}\pi_{\zeta}$")
		print(B[0, 2, 2])
		print("$\pi_{\zeta}\pi_{\zeta}\pi_{\zeta}$")
		print(B[2, 2, 2])
		...
		print("$\zeta\mathcal{F}\mathcal{F}$")
		print(B[1, 1, 0])
		print(B[1, 0, 1])
		print(B[0, 1, 1])
		...
		print("$\pi_{\zeta}\mathcal{F}\mathcal{F}$")
		print(B[1, 1, 2])
		print(B[1, 2, 1])
		print(B[2, 1, 1])
		...
		print("$\pi_{\mathcal{F}}\mathcal{F}\mathcal{F}$")
		print(B[1, 1, 3])
		print(B[1, 3, 1])
		print(B[3, 1, 1])
		...
		print("$\mathcal{F}\pi_{\zeta}\pi_{\zeta}$")
		print(B[2, 2, 1])
		print(B[2, 1, 2])
		print(B[1, 2, 2])
		...
		print("$\pi_{\mathcal{F}}\pi_{\zeta}\pi_{\zeta}$")
		print(B[2, 2, 3])
		print(B[2, 3, 2])
		print(B[3, 2, 2])
		...
		print("$\pi_{\mathcal{F}}\pi_{\mathcal{F}}\zeta$")
		print(B[3, 3, 0])
		print(B[3, 0, 3])
		print(B[0, 3, 3])
		...
		print("$\pi_{\mathcal{F}}\pi_{\mathcal{F}}\mathcal{F}$")
		print(B[3, 3, 1])
		print(B[3, 1, 3])
		print(B[1, 3, 3])
		...
		print("$\pi_{\mathcal{F}}\pi_{\mathcal{F}}\pi_{\zeta}$")
		print(B[3, 3, 2])
		print(B[3, 2, 3])
		print(B[2, 3, 3])
		...
		print("$\mathcal{F}\pi_{\mathcal{F}}\pi_{\zeta}$")
		print(B[1, 2, 3])
		print(B[1, 3, 2])
		print(B[2, 1, 3])
		print(B[2, 3, 1])
		...
		print("$\pi_{\mathcal{F}}\pi_{\zeta}\zeta$")
		print(B[0, 2, 3])
		print(B[0, 3, 2])
		print(B[2, 0, 3])
		print(B[2, 3, 0])
		...
		print("$\mathcal{F}\pi_{\mathcal{F}}\zeta$")
		print(B[0, 1, 3])
		print(B[0, 3, 1])
		print(B[1, 0, 3])
		print(B[1, 3, 0])
	...
	def df_dN(self, y, N, k1, k2, k3):
		...
		#dB_dN = np.reshape(dB1 + dB2 + dB3, (2*Nfield)**3)
	...
	def f_solution(self, k1, k2, k3):
		...
		# b = 1/8/mdl.a_f(Nspan)**2/mdl.H_f(Nspan)**2
		# c = 1/8/mdl.a_f(Nspan)**3/mdl.epsilon_f(Nspan)/mdl.H_f(Nspan)/self.Mp**2

		# k1k3 = (k2**2 - k1**2 - k3**2)/2
		# k2k3 = (k1**2 - k2**2 - k3**2)/2
		# k1k2 = (k3**2 - k1**2 - k2**2)/2

		# boundary_term_a = - a * (Sigma_Re_k1[0, 1]*Sigma_Re_k2[0, 0]
		...
		# boundary_term_b = -(2*b*(k1**2 + k2**2 - k1k3**2/k3**2 - k2k3**2/k3**2)*Sigma_Re_k1[0, 0]*Sigma_Re_k2[0, 0]
		# 				  +2*b*(k1**2 + k3**2 - k1k2**2/k2**2 - k2k3**2/k2**2)*Sigma_Re_k1[0, 0]*Sigma_Re_k3[0, 0]
		# 				  +2*b*(k2**2 + k3**2 - k2k3**2/k1**2 - k1k3**2/k1**2)*Sigma_Re_k2[0, 0]*Sigma_Re_k3[0, 0] )

		# boundary_term_c = -2*c*( (-2 + mdl.epsilon_f(Nspan)*(1-k1k2**2/k1**2/k2**2))*Sigma_Re_k3[0, 0]*Sigma_Re_k2[0, 2]
		#  					   + (-2 + mdl.epsilon_f(Nspan)*(1-k1k3**2/k1**2/k3**2))*Sigma_Re_k2[0, 0]*Sigma_Re_k3[0, 2]
		#  					   + (-2 + mdl.epsilon_f(Nspan)*(1-k2k3**2/k2**2/k3**2))*Sigma_Re_k1[0, 0]*Sigma_Re_k3[0, 2]
		#  					   + (-2 + mdl.epsilon_f(Nspan)*(1-k1k2**2/k1**2/k2**2))*Sigma_Re_k3[0, 0]*Sigma_Re_k1[0, 2]
		#  					   + (-2 + mdl.epsilon_f(Nspan)*(1-k1k3**2/k1**2/k3**2))*Sigma_Re_k2[0, 0]*Sigma_Re_k1[0, 2]
		#  					   + (-2 + mdl.epsilon_f(Nspan)*(1-k2k3**2/k2**2/k3**2))*Sigma_Re_k1[0, 0]*Sigma_Re_k2[0, 2] )


		# B[0, 0, 0] += boundary_term_a + boundary_term_b + boundary_term_c
		...
		return f#, np.asarray(uAB), np.asarray(uABC)